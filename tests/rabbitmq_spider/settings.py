...
def create_settings(spider_path, user_redis=True, *args, **kwargs):
    ...
    if user_redis:
        ...
        settings.SCHEDULER = "scrapy_cffi.scheduler.RabbitMqScheduler" # Starting the Redis scheduler requires configuring Redis information
