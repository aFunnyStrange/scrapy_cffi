...
Let the backend publish task messages to the selected ingress transport, then
let the corresponding queue Spider consume them. See the current
[system boundaries](../../assets/diagrams/system-overview.svg).
